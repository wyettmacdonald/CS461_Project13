...
package proj17DouglasMacDonaldZhang;
...
public class PreferenceController {
    ...
    private CheckMenuItem suggestionsModeItem;
    ...
    private String curInstructionColor;
    private String curDirectiveColor;
    private String curRegisterColor;
    private String curMipsStrColor;
    ...
    public PreferenceController(VBox vBox, Console console, TabPane structureTabPane,
                                CheckMenuItem fileStructureItem, CheckMenuItem directoryTreeItem, CheckMenuItem suggestionsModeItem,
        ...
        this.suggestionsModeItem = suggestionsModeItem;
    ...
    private void setCurColorToDefault(){
        ...
        if(!this.vBox.getStylesheets().contains(nightMode)) {
            ...
            this.curDirectiveColor = "Hotpink";
            this.curInstructionColor = "Blue";
            this.curRegisterColor = "Red";
            this.curMipsStrColor = "Limegreen";
        }else{
    ...
    private void updateColor(String type, String color){
        ...
        String instrColorStyle = "-Instr-color: " + this.curInstructionColor + ";";
        String dirColorStyle = "-Dir-color: " + this.curDirectiveColor + ";";
        String regColorStyle = "-Reg-color: " + this.curRegisterColor + ";";
        String mipsStrColorStyle = "-Mips-Str-color: " + this.curMipsStrColor + ";";
        ...
        switch (type){
            ...
            case("Paren"):
                ...
                break;
            case("Instruction"):
                instrColorStyle = "-Instr-Color:" + color+ ";";
                this.curInstructionColor = color;
                break;
            case("Directive"):
                dirColorStyle = "-Dir-Color:" + color+ ";";
                this.curDirectiveColor = color;
                break;
            case("Register"):
                regColorStyle = "-Reg-Color:" + color+ ";";
                this.curRegisterColor = color;
                break;
            case("MipsString"):
                mipsStrColorStyle = "-Mips-Str-Color:" + color+ ";";
                this.curMipsStrColor = color;
                break;
        }
        //Update the color style
        this.vBox.setStyle(keywordColorStyle + strColorStyle + intColorStyle + parenColorStyle +
                instrColorStyle + dirColorStyle + regColorStyle + mipsStrColorStyle);
    }
