...
/**
 * The <tt>BinaryCompLeqExpr</tt> class represents less than or equal to expressions.
 ...
 * @see BinaryCompExpr
 */
public class BinaryCompLeqExpr extends BinaryCompExpr {
    /**
     ...
     */
    public BinaryCompLeqExpr(int lineNum, Expr leftExpr, Expr rightExpr) {
