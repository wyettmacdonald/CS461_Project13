...
/**
 * The <tt>BinaryCompNeExpr</tt> class represents not equals expressions.  It
 ...
 * @see BinaryCompExpr
 */
public class BinaryCompNeExpr extends BinaryCompExpr {
    /**
     ...
     */
    public BinaryCompNeExpr(int lineNum, Expr leftExpr, Expr rightExpr) {
