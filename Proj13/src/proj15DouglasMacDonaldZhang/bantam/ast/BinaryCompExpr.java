...
/**
 * The abstract <tt>BinaryCompExpr</tt> class represents comparison expressions.
 ...
 * the bantam.visitor method for BinaryExpr, however, some functionality may need to
 * be implemented in the bantam.visitor method for each subclass.
 *
 * @see ASTNode
 * @see BinaryExpr
 */
