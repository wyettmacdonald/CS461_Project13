...
public class ToolbarController {
    ...
    private ErrorHandler currentErrorHandler;
    private Method currentMethod;
 //   private ClassTreeNode findMethod = new ClassTreeNode().getClassMap();
 //   private SymbolTable methods = ClassTreeNode.getMethodSymbolTable();
    ...
    public void handlePrevError() {
        ...
        for(Error err : currentErrorHandler.getErrorList()) {
...
//        if(currentMethod.getFormalList() == null) {
////            System.out.println("There are no methods in this program. ");
////            return;
////        }

        System.out.println("Method " + currentMethod.getLineNum()); ///use visitor instead to find current method line num

        StyledTextArea textArea = codeTabPane.getCodeArea();
        textArea.moveTo(currentMethod.getLineNum(), 0);
//        textArea.moveTo(0);
        textArea.requestFollowCaret();
    }
...
//        }
        ArrayList<Integer> errorArray = new ArrayList<>();
        for(Error err : currentErrorHandler.getErrorList()) { //left this because i didnt know if we wanted to use lineNums
